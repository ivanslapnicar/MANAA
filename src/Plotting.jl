...
# ╔═╡ 789ca882-8637-11ee-3efb-63a8a7a334b9
using LinearAlgebra, Random, PlutoUI, Plots, JLD2, Statistics

# ╔═╡ 467361ad-501f-4b1d-be0a-a4779805e5df
md"""
# Plotting the results of "Fast computations with arrowhead and DPRk matrices over associative fields"
...
# ╔═╡ f51a4f1a-48b2-4fc4-a3e9-fc96ce81d12e
md"""
#### General Arrowhead matrices
"""

# ╔═╡ 7694a3d7-9e87-46ac-ab31-b10374021b6d
begin
	k=8
	filename=Vector{String}(undef,k)
...
(matrixtype,n,Esolver,tol,ext)=split(filename[1],"_")

# ╔═╡ 8afabf3c-86ee-472c-8639-4f5d93f9025b
v=parse(Int,n)
...
for i=1:4
	...
	figname=chop(filename[i],tail=6)*".png"
	savefig(figname)
	# Means and n
	Nk[i]=n
